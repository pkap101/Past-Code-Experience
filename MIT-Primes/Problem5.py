...
#my input file is Problem5TestData.txt
filePath = input("Enter file path for input data:")
#my output file is english.txt
exportFile = input("Enter file path for english.txt output file to write encodings:")

#uses input file to create 1 list with letters, 1 list with corresponding frequencies, 1 list for encodings
